...
class MenuTenantController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $menu_tenant->save();
        return redirect('/menu_tenant')->with('success', 'Menu ' . $menu_tenant->nama_menu . ' has been Updated!!');
    }
    ...
    public function destroy($id)
    {
        ...
        $menu_tenant->save();
        return redirect('/menu_tenant')->with('success', 'Menu ' . $menu_tenant->nama_menu . ' Successfully deleted !!');
    }
