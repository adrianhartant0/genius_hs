...
class UnitTenantController extends Controller
{
    ...
    public function create()
    {
        //
        $temp = UnitTenant::all();
        $temp1 = TenantCategory::all();
        return view('app', [
                                'module'            => 'unit_tenant',
                                'action'            => 'add',
                                'unitaparttenants'  => $temp,
                                'tenantcategorys'  => $temp1
                            ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $unit_tenant->id_tenant_category       = $request->id_tenant_category;
    ...
    public function show($id)
    {
        ...
        $data_master_category  = TenantCategory::where('status', 1)
                                        ->get();
