...
class EacMenuController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('app', [
                                    ...
                                    ->where('mst_unit_tenant.id_unit_tenant', '=', 3)
                                    ->get()
                                ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $menu_tenant->save();
        return redirect('/e_ac_menu')->with('success', 'New Menu has been Submit!!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $menu_tenant->save();
        return redirect('/e_ac_menu')->with('success', 'Menu ' . $menu_tenant->nama_menu . ' has been Updated!!');
    }
    ...
    public function destroy($id)
    {
        ...
        $menu_tenant->save();
        return redirect('/e_ac_menu')->with('success', 'Menu ' . $menu_tenant->nama_menu . ' Successfully deleted !!');
    }
