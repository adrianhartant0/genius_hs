...
class BillOwnerController extends Controller
{
    ...
    {
        // $billing_denda = BillDenda::select('billing_denda.*',DB::raw('sum(billing_denda.total_denda) as TotalDenda'),'billing_owner.id_billing_owner','billing_owner.tgl_cetak')
        //     ->join('billing_owner','billing_owner.id_billing_owner','=','billing_denda.id_billing_owner')
        //     ->whereMonth('billing_owner.tgl_cetak','<=','billing_denda.bulan')
        //     ->whereYear('billing_owner.tgl_cetak','<=','billing_denda.tahun')
        //     ->where('billing_owner.id_unit_owner', '=', $id)
        //     ->where('billing_denda.status','=', 0)
        //     ->groupBy('billing_denda.id_unit_owner')
        //     ->toSql();
        //     dd($billing_denda);
        ...
        // view()->share('billing_denda', $billing_denda);
