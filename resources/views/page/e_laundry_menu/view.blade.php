<div class="page-header">
    <h1 class="grey">
        ...
        <a href='/e_laundry_menu' class="btn  btn-yellow btn-sm pull-right type=" submit">
...
<div class="col-xs-12">
    <!-- PAGE CONTENT BEGINS -->
    <form class="form-horizontal" role="form" id="form_add" method="post" action="{{url('/e_laundry_menu/'. $id)}}">
        @csrf
        <input name="_method" type="hidden" value="PATCH">
        <input type="hidden" name="status" id="status" value="1" />
        <input type="hidden" name="status_available" id="status_available" value="1" />
        <input type="hidden" name="id_unit_tenant" id="id_unit_tenant" value="1" />
        <input type="hidden" name="id_menu_category" id="id_menu_category" value="1" />
        ...
        <div class="clearfix form-actions">
            <div class="col-md-offset-3 col-md-9">
                <a href='/e_laundry_menu' class="btn btn-primary type=" submit">
                    <i class="ace-icon fa fa-times"></i>
                    CLOSE
                </a>
            </div>
