            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="center">Bill Remain</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="center">{{number_format($item->total_tagihan_all + $item->total_denda - $item->jml_bayar)}}</td>
                        @if($item->total_tagihan_all + $item->total_denda - $item->jml_bayar == 0)
                        ...
                        <td class="center">
                            <div class="hidden-sm hidden-xs action-buttons">
                                ...
                                &nbsp;                               
                                @if(Auth::user()->priv_status == 1 && $item->total_tagihan_all + $item->total_denda - $item->jml_bayar != 0||
                                Auth::user()->priv_status == 4 && $item->total_tagihan_all + $item->total_denda - $item->jml_bayar != 0||
                                Auth::user()->priv_status == 5 && $item->total_tagihan_all + $item->total_denda - $item->jml_bayar != 0)

                                @if(Auth::user()->priv_status == 1 && $item->jml_bayar == 0 ||
                                Auth::user()->priv_status == 4 && $item->jml_bayar == 0 ||
                                Auth::user()->priv_status == 5 && $item->jml_bayar == 0)
                                <a class="green" title="EDIT" data-placement="bottom" href='/bill_owner/{{$item->id_billing_owner}}/edit'>
                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                </a>
                                &nbsp;
                                @endif
                                <a href='/invoice/{{$item->id_billing_owner}}' title="CREATE INVOICE"
