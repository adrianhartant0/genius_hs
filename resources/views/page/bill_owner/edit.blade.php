...
<div class="col-xs-12">
    <!-- PAGE CONTENT BEGINS -->
    <form class="form-horizontal" role="form" name="fbill" id="form_add" method="post" action="{{url('/bill_owner/'.$id)}}">
        @csrf
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <select class="chosen-select form-control" name='id_unit_owner' id="form-field-select-1"
                    data-placeholder="Choose Occupant..." onchange="setLuas(this)" disabled>
                    <option value=""> </option>
                    @foreach ($data_unit_owner as $item)
                    @php
                    $selected = ($item->id_unit_owner==$data->id_unit_owner)?'selected':'';
                    @endphp
                    <option value="{{ $item->id_unit_owner }}" {{ $selected }} data-luas="{{ $item->luas_unit }}">{{
                        $item->namaPenghuni }}
                    </option>
                    @endforeach
                </select>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <div class="input-group">
                    <input class="form-control date-picker" id="id-date-picker-3" name="tgl_cetak"
                        placeholder="Invoice Date" type="text" data-date-format="dd-mm-yyyy" value='{{$data->tgl_cetak}}' />
            ...
            <div class="col-sm-3">
                <div class="input-group">
                    <input class="form-control date-picker" id="id-date-picker-4" name="tgl_jatuh_tempo"
                        placeholder="Due Date" type="text" data-date-format="dd-mm-yyyy" value='{{$data->tgl_jatuh_tempo}}' />
                    <span class="input-group-addon">
                        <i class="fa fa-calendar bigger-110"></i>
                    </span>
                </div>
            ...
            <div class="tab-content fad">
                <div id="tab1" class="tab-pane fade in active">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="ribuan" id="jml_sebelum" name="jml_sebelum" onchange="HitungUlang()"
                                onclick="HitungUlang()" value='{{$data->jml_sebelum}}'>
                        </div>

                        <label class="col-sm-1 control-label no-padding-right" for="form-field-1"> Power Installed
                        </label>
                        <div class="col-sm-1">
                            <input type="text" class="ribuan" id="daya_terpasang" name="daya_terpasang" onchange="HitungUlang()" value='{{$data->jml_daya_terpasang}}'>
                        </div>
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="ribuan" id="jml_biaya_bpju" name="jml_biaya_bpju"  value='{{$data->jml_biaya_bpju}}' readonly />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            ...
                            value='{{$data->jml_sesudah}}' required />
                        </div>
                        ...
                        <div class="col-sm-1">
                            <input type="text" class="ribuan" id="biaya_pemeliharaan" name="biaya_pemeliharaan" value="{{$get_service_fee->harga_tarif}}"
                                onchange="HitungUlang()"  value='{{$data->jml_biaya_pemeliharaan}}' required />
                        </div>
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="ribuan" id="biaya_admin" name="biaya_admin"  value='{{$data->jml_biaya_admin}}' readonly />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="ribuan" id="total_pemakaian" name="total_pemakaian" value='{{$data->total_pemakaian}}' readonly />
                        </div>
                        ...
                        <div class="col-sm-1">
                            <input type="text" class="ribuan" id="jml_biaya_ppn" name="jml_biaya_ppn" value='{{$data->jml_biaya_ppn}}' readonly />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="ribuan" id="jml_pemakaian" name="jml_pemakaian" value='{{$data->jml_pemakaian}}' readonly />
                        </div>

                        <label class="col-sm-1 control-label no-padding-right" for="form-field-1"> Sub Total </label>
                        <div class="col-sm-1">
                            <input type="text" class="ribuan" id="total_pemeliharaan" name="total_pemeliharaan"
                            value='{{$data->total_pemeliharaan}}' readonly />
                        </div>
                        ...
                        <div class="col-sm-2">
                            ...
                            value='{{$data->total_bagian_bersama}}' readonly />
                        </div>

                        <label class="col-sm-1 control-label no-padding-right" for="form-field-1"> Sub Total</label>
                        <div class="col-sm-2">
                            <input type="text" class="ribuan" id="jml_bpju_admin_ppn" name="jml_bpju_admin_ppn"
                            value='{{$data->jml_bpju_admin_ppn}}' readonly />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <span class="input-icon  input-icon-right">
                                <input type="text" class="ribuan" name='total_tagihan' id="total_tagihan" value='{{$data->total_tagihan}}' onchange="HitungUlangListrik2()"
                                    size="50">
                ...
                <div id="tab2" class="tab-pane fade">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="ribuan" id="jml_sebelum_air" name="jml_sebelum_air" onchange="HitungUlangAir()"
                                onclick="HitungUlangAir()" class="col-sm-12" value='{{$data->jml_sebelum_air}}' required />
                        </div>
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="ribuan" id="jml_beban_tetap" name="jml_beban_tetap" onchange="HitungUlangAir()"
                                onclick="HitungUlangAir()" value="{{$get_fix_load->harga_tarif}}" value='{{$data->jml_beban_tetap}}' required />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="ribuan" id="jml_sesudah_air" name="jml_sesudah_air" onchange="HitungUlangAir()"
                                class="col-xs-10 col-sm-12" value='{{$data->jml_sesudah_air}}' required />
                        </div>
                        ...
                        <div class="col-sm-2">
                            ...
                            value='{{$data->jml_biaya_admin_air}}' readonly />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            ...
                            value='{{$data->total_pemakaian_air}}' readonly />
                        </div>
                        ...
                        <div class="col-sm-2">
                            ...
                            value='{{$data->jml_biaya_ppn_air}}' readonly />
                        </div>
                    </div>
                        ...
                        <div class="col-sm-9">
                            <span class="input-icon  input-icon-right">
                                <input type="text" class="ribuan" name='jml_tagihan_air' id="jml_tagihan_air" onchange="HitungUlangAir2()"
                                    size="50"  value='{{$data->total_tagihan_air}}'>
                ...
                <div id="tab3" class="tab-pane fade">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="keterangan_sc_ikkl" name="keterangan_sc_ikkl" placeholder="Description"
                                class="col-xs-10 col-sm-9"  value='{{$data->keterangan_sc_ikkl}}' required />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="ribuan" id="luas_unit" name="luas_unit" size="16" value='{{$data->luas_unit}}' readonly />
                            <label>m2</label>
                        </div>
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-2">
                            <input type="text" id="luas_unit2" name="luas_unit2" size="16" value='{{$data->luas_unit}}' readonly />
                            <label>m2</label>
                        </div>
                    </div>
                    <br />
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="ribuan" id="total_service_charge" name="total_service_charge"
                                class="col-xs-10 col-sm-12" value='{{$data->total_service_charge}}' readonly />
                        </div>
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-3">
                            ...
                            value='{{$data->jml_biaya_asuransi}}' readonly />
                        </div>
                    </div>
                    <br />
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="ribuan" id="luas_unit3" name="luas_unit3" size="16" value='{{$data->luas_unit}}' readonly />
                            <label>m2</label>
                        </div>
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="ribuan" id="luas_unit4" name="luas_unit4" size="16" value='{{$data->luas_unit}}' readonly />
                            <label>m2</label>
                        </div>
                    </div>
                    <br />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="ribuan" id="jml_biaya_pbb" name="jml_biaya_pbb" class="col-xs-10 col-sm-12"
                                value='{{$data->jml_biaya_pbb}}' readonly />
                        </div>
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="ribuan" id="jml_sinking_fund" name="jml_sinking_fund" class="col-xs-10 col-sm-12"
                                value='{{$data->jml_sinking_fund}}' readonly />
                        </div>
                    </div>
                    <br />
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="ribuan" id="luas_unit5" name="luas_unit5" size="16" value='{{$data->luas_unit}}' readonly />
                            <label>m2</label>
                        </div>
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="ribuan" id="luas_unit6" name="luas_unit6" size="16" value='{{$data->luas_unit}}' readonly />
                            <label>m2</label>
                        </div>
                    </div>
                    <br />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="ribuan" id="luas_unit7" name="luas_unit7" size="16" value='{{$data->luas_unit}}' readonly />
                            <label>m2</label>
                        </div>
                    </div>
                    <br />
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            ...
                            value='{{$data->jml_parkir}}' readonly />
                        </div>
                    </div>
                    <div class="hr hr-double hr-dotted hr18"></div>
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            ...
                            value='{{$data->total_service_charge + $data->jml_biaya_pbb + $data->jml_slf + $data->jml_parkir}}' readonly />
                        </div>
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-2">
                            ...
                            value='{{$data->jml_biaya_asuransi + $data->jml_sinking_fund + $data->jml_hgb}}' readonly />
                        </div>
                        <div class="col-sm-1">
                        ...
                        <div class="col-sm-3">
                            ...
                            value='{{$data->ppn_sc_ikkl}}' readonly />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <span class="input-icon  input-icon-right">
                                <input type="text" class="ribuan" name='jml_sc_ikkl' id="jml_sc_ikkl" size="50" value='{{$data->jml_sc_ikkl}}' />
                                <i class="ace-icon fa fa-check bigger-110"></i>
                            </span>
                        </div>
                    </div>
                ...
                <div id="tab4" class="tab-pane fade">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="ribuan" id="jml_tagihan_listrik2" name="jml_tagihan_listrik2"
                                class="col-xs-10 col-sm-5"  value='{{$data->total_tagihan}}' readonly />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            value='{{$data->total_tagihan_air}}' readonly />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="ribuan" id="total_service_charge_ikkl" name="total_service_charge_ikkl"
                                class="col-xs-10 col-sm-5" value='{{$data->jml_sc_ikkl}}' readonly />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <span class="input-icon  input-icon-right">
                                ...
                                value='{{$data->total_tagihan_all}}' readonly />
                                <i class="ace-icon fa fa-check bigger-110"></i>
                            </span>
                        </div>
                    </div>
