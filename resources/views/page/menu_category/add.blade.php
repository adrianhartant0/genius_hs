...
<div class="col-xs-12">
    <!-- PAGE CONTENT BEGINS -->
    <form class="form-horizontal" role="form" id="form_add" method="post" action="{{url('/menu_category')}}">
        @csrf
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="nama_menu_category" name="nama_menu_category" placeholder="Menu Category Name"
