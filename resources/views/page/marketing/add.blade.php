<form id="form_add" method="post" action="{{url('/marketing')}}">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="clear_data()"><span
                aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Add Marketing</h4>
    </div>
        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-5">
                    <input type="text" id="nama_marketing" name="nama_marketing" required="required" class="form-control col-md-7 col-xs-12">
                </div>
            </div>
        </div>
    </div>
